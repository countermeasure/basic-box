...
wget --timestamping https://mullvad.net/media/app/MullvadVPN-2022.5_amd64.deb

# Ensure the fd package is present.
wget --timestamping "https://github.com/sharkdp/fd/releases/download/v8.6.0/\
fd_8.6.0_amd64.deb"
...
wget --timestamping "https://github.com/junegunn/fzf/releases/download/0.35.1/\
fzf-0.35.1-linux_amd64.tar.gz"
...
cp 0.35.1.tar.gz fzf-0.35.1-source.tar.gz
...
# The musl version is needed as of delta 0.15.1 because the gnu version
# requires a newer version of the libc6 package than Debian 11 provides.
# The delta .deb package doesn't contain completions as of version 0.15.1, so
# manual installation is necessary.
wget --timestamping "https://github.com/dandavison/delta/releases/download/\
0.15.1/delta-0.15.1-x86_64-unknown-linux-musl.tar.gz"
...
cp 0.15.1.tar.gz delta-0.15.1-source.tar.gz
...
# wget's --timestamping option working.
cp v2.32.2.tar.gz direnv-v2.32.2-source.tar.gz
...
v1.12.0/starship-x86_64-unknown-linux-gnu.tar.gz"
...
# wget's --timestamping option working.
cp v2.3.9.tar.gz pyenv-v2.3.9-source.tar.gz
