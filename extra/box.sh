...
${custom_keybindings_key_path}/custom0/"
  _test_gsettings ${custom_keybinding_0} binding "'<Super>Return'"
  _test_gsettings ${custom_keybinding_0} command "'gnome-terminal'"
  _test_gsettings ${custom_keybinding_0} name "'Terminal'"
